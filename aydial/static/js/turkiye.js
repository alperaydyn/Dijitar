...
for (var county in paths) {
    ...
    if(arr[obj.id] != 'blank') 
    {
        ...
        obj.node.title = paths[arr[obj.id]].name;
        obj.attr(attributes);
        obj.attr( { title: paths[arr[obj.id]].name } );
        ...
        obj.click(function(){	
            ...
            if(paths[arr[this.id]].value == 'notSelected')
            {
                ...
                previouscountyselected = paths[arr[this.id]].id;
